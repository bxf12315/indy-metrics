package org.commonjava.indy.metrics.common;
 ...
 */
public class IndyZabbixSenderTmp
{
    private ZabbixSender sender;

    private static final Logger logger = LoggerFactory.getLogger( IndyZabbixSenderTmp.class );
    ...
    public static IndyZabbixSenderTmp.Builder create(){ return new IndyZabbixSenderTmp.Builder();}
    ...
    public static class Builder
    {
        ...
        public IndyZabbixSenderTmp build(){
            return new IndyZabbixSenderTmp( this.bCreateNotExistHostGroup,
    ...
    public IndyZabbixSenderTmp( boolean bCreateNotExistHostGroup, boolean bCreateNotExistHost, boolean bCreateNotExistItem,
