...
public class ReporterIntializer {
    ...
    private final static String INDY_METRICS_REPORTER_GRPHITEREPORTER_HEALTHCHECK_PERIOD = "GraphiteReporter.healthcheck.period";
    ...
    private static void initConsoleReporter(MetricRegistry metrics, Properties properties) {
        ConsoleReporter.forRegistry(metrics).build().start(Integer.parseInt(
                properties.getProperty(INDY_METRICS_REPORTER_GRPHITEREPORTER_SIMPLE_PERIOD)), TimeUnit.SECONDS);
    }
    ...
    private static void initGraphiteReporterForSimpleMetric(MetricRegistry metrics, Properties properties) {
        ...
        final GraphiteReporter reporter = GraphiteReporter.forRegistry(metrics)
                ...
                .build(graphite);
        reporter.start(Integer.parseInt(properties.getProperty(INDY_METRICS_REPORTER_GRPHITEREPORTER_SIMPLE_PERIOD)), TimeUnit.SECONDS);
    }
    ...
    private static void initGraphiteReporterForJVMMetric(MetricRegistry metrics, Properties properties) {
        ...
        final GraphiteReporter reporter = GraphiteReporter.forRegistry(metrics)
                ...
                .build(graphite);
        reporter.start(Integer.parseInt(properties.getProperty(INDY_METRICS_REPORTER_GRPHITEREPORTER_JVM_PERIOD)), TimeUnit.SECONDS);
    }
    ...
    private static void initGraphiteReporterForHealthCheckMetric(MetricRegistry metrics, Properties properties) {
        ...
        final GraphiteReporter reporter = GraphiteReporter.forRegistry(metrics)
                ...
                .build(graphite);
        reporter.start(Integer.parseInt(properties.getProperty(INDY_METRICS_REPORTER_GRPHITEREPORTER_HEALTHCHECK_PERIOD)), TimeUnit.SECONDS);
    }
}
